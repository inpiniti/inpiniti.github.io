...
2. FLUX 패턴
    ...
    2. 설명은 View에서 Action을 호출하면 Dispatcher를 통해 Store라는 공간에 Data가 보관이 되고 다시 뷰로 전달되는 흐름이라고 하는데, 조금 어렵습니다.
    3. FLUX 패턴을 알아들은 똑똑한 사람이 Redux를 만들어 발표하게 되었습니다.
    4. 이후 각 프레임워크 진영에게 영감을 주어, Vuex 등의 상태관리 라이브러리들이 만들어지기 시작했습니다.
