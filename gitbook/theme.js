!function e(t, n, r) {
    ...
    1: [function (e, t, n) {
        !function (e, n) {
            ...
            function b(e, t, n, r, o) {
                for (var i, a, s, u, l, c, f = t.createDocumentFragment(), p = [], h = 0, d = e.length; h < d; h++) if (i = e[h], i || 0 === i) if ("object" === de.type(i)) de.merge(p, i.nodeType ? [i] : i); else if (Ge.test(i)) {
                ...
                for (f.textContent = "", h = 0; i = p[h++];) if (r && de.inArray(i, r) > -1) o && o.push(i); else if (l = de.contains(i.ownerDocument, i), a = v(f.appendChild(i), "script"), l && y(a), n) for (c = 0; i = a[c++];) Ke.test(i.type || "") && n.push(i);
                return f
            }
            ...
            function W(e, t, n) {
                var r, o, i, a, s, u, l, c, f = "width" in t || "height" in t, p = this, h = {}, d = e.style,
                ...
                if (u = !de.isEmptyObject(t), u || !de.isEmptyObject(h)) {
                    ...
                    for (r in h) u || (v ? "hidden" in v && (g = v.hidden) : v = Fe.access(e, "fxshow", {display: l}), i && (v.hidden = !g), g && m([e], !0), p.done(function () {
            ...
            function K(e, t, n, r) {
                ...
                }); else if (n || "object" !== de.type(t)) r(e, t); else for (o in t) K(e + "[" + o + "]", t[o], n, r)
            }
            ...
            var ee = [], te = e.document, ne = Object.getPrototypeOf, re = ee.slice, oe = ee.concat, ie = ee.push,
                ae = ee.indexOf, se = {}, ue = se.toString, le = se.hasOwnProperty, ce = le.toString,
                fe = ce.call(Object), pe = {}, he = "3.1.1", de = function (e, t) {
                    return new de.fn.init(e, t)
                }, ge = /^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g, me = /^-ms-/, ve = /-([a-z])/g, ye = function (e, t) {
                    return t.toUpperCase()
                };
            de.fn = de.prototype = {
                jquery: he, constructor: de, length: 0, toArray: function () {
                    return re.call(this)
                }, get: function (e) {
                ...
                }, push: ie, sort: ee.sort, splice: ee.splice
                ...
                expando: "jQuery" + (he + Math.random()).replace(/\D/g, ""), isReady: !0, error: function (e) {
                    ...
                    var n, o = 0;
                    if (r(e)) for (n = e.length; o < n && t.call(e[o], o, e[o]) !== !1; o++) ; else for (o in e) if (t.call(e[o], o, e[o]) === !1) break;
                    return e
                }, trim: function (e) {
                    ...
                    var o, i, a = 0, s = [];
                    if (r(e)) for (o = e.length; a < o; a++) i = t(e[a], a, n), null != i && s.push(i); else for (a in e) i = t(e[a], a, n), null != i && s.push(i);
                    return oe.apply([], s)
            ...
            var be = function (e) {
                function t(e, t, n, r) {
                    ...
                    if (!r && ((t ? t.ownerDocument || t : _) !== L && O(t), t = t || L, F)) {
                        ...
                        if (C.qsa && !X[e + " "] && (!P || !P.test(e))) {
                            if (1 !== d) p = t, c = e; else if ("object" !== t.nodeName.toLowerCase()) {
                ...
                function d(e, t, n) {
                    ...
                    return t.first ? function (t, n, o) {
                        ...
                        } else for (; t = t[r];) if (1 === t.nodeType || a) if (f = t[$] || (t[$] = {}), c = f[t.uniqueID] || (f[t.uniqueID] = {}), o && o === t.nodeName.toLowerCase()) t = t[r] || t; else {
                ...
                function y(e, t, n, o, i, a) {
                    return o && !o[$] && (o = y(o)), i && !i[$] && (i = y(i, a)), r(function (r, a, s, u) {
                        var l, c, f, p = [], h = [], d = a.length, g = r || m(t || "*", s.nodeType ? [s] : s, []),
                            y = !e || !r && t ? g : v(g, p, e, s, u), b = n ? i || (r ? e : d || o) ? [] : a : y;
                ...
                function b(e) {
                    for (var t, n, r, o = e.length, i = T.relative[e[0].type], a = i || T.relative[" "], s = i ? 1 : 0, u = d(function (e) {
                        ...
                        return t = null, o
                    }]; s < o; s++) if (n = T.relative[e[s].type]) c = [d(g(c), n)]; else {
                        if (n = T.filter[e[s].type].apply(null, e[s].matches), n[$]) {
                            for (r = ++s; r < o && !T.relative[e[r].type]; r++) ;
                            return y(s > 1 && g(c), s > 1 && h(e.slice(0, s - 1).concat({value: " " === e[s - 2].type ? "*" : ""})).replace(se, "$1"), n, s < r && b(e.slice(s, r)), r < o && b(e = e.slice(r)), r < o && h(e))
                        }
                        c.push(n)
                    }
                    return g(c)
                ...
                function x(e, n) {
                    var o = n.length > 0, i = e.length > 0, a = function (r, a, s, u, l) {
                        var c, f, p, h = 0, d = "0", g = r && [], m = [], y = A, b = r || i && T.find.TAG("*", l),
                ...
                var w, C, T, k, j, E, N, S, A, q, D, O, L, H, F, P, I, R, M, $ = "sizzle" + 1 * new Date,
                    _ = e.document, W = 0, B = 0, U = n(), z = n(), X = n(), K = function (e, t) {
                        return e === t && (D = !0), 0
                    ...
                    ce = new RegExp("=" + ne + "*([^\\]'\"]*?)" + ne + "*\\]", "g"), fe = new RegExp(ie),
                    pe = new RegExp("^" + re + "$"), he = {
                        ID: new RegExp("^#(" + re + ")"),
                        CLASS: new RegExp("^\\.(" + re + ")"),
                        TAG: new RegExp("^(" + re + "|[*])"),
            ...
            var xe = function (e, t, n) {
                    ...
                    return n
                }, Ce = de.expr.match.needsContext, Te = /^<([a-z][^\/\0>:\x20\t\r\n\f]*)[\x20\t\r\n\f]*\/?>(?:<\/\1>|)$/i,
                ke = /^.[^:#\[\.,]*$/;
            ...
            de.Callbacks = function (e) {
                ...
                Deferred: function (t) {
                    ...
                    var t = arguments.length, n = t, r = Array(n), o = re.call(arguments), i = de.Deferred(),
                        a = function (e) {
                            return function (n) {
            ...
            var Fe = new f, Pe = new f, Ie = /^(?:\{[\w\W]*\}|\[[\w\W]*\])$/, Re = /[A-Z]/g;
            de.extend({
                hasData: function (e) {
            ...
            var Me = /[+-]?(?:\d*\.|)\d+(?:[eE][+-]?\d+|)/.source,
                $e = new RegExp("^(?:([+-])=|)(" + Me + ")([a-z%]*)$", "i"), _e = ["Top", "Right", "Bottom", "Left"],
                We = function (e, t) {
            ...
            var Ge = /<|&#?\w+;/;
            !function () {
                var e = te.createDocumentFragment(), t = e.appendChild(te.createElement("div")),
            ...
            de.event = {
                global: {}, add: function (e, t, n, r, o) {
                    ...
                    var t, n, r, o, i, a, s = de.event.fix(e), u = new Array(arguments.length),
                        l = (Fe.get(this, "events") || {})[s.type] || [], c = de.event.special[s.type] || {};
            ...
            var et = /<(?!area|br|col|embed|hr|img|input|link|meta|param)(([a-z][^\/\0>\x20\t\r\n\f]*)[^>]*)\/>/gi,
                tt = /<script|<style|<link/i, nt = /checked\s*(?:[^=]|=\s*.checked.)/i, rt = /^true\/(.*)/,
                ot = /^\s*<!(?:\[CDATA\[|--)|(?:\]\]|--)>\s*$/g;
            de.extend({
                htmlPrefilter: function (e) {
                    ...
                    if (t) if (n) for (i = i || v(e), a = a || v(s), r = 0, o = i.length; r < o; r++) N(i[r], a[r]); else N(e, s);
            ...
            var it = /^margin/, at = new RegExp("^(" + Me + ")(?!px)[a-z%]+$", "i"), st = function (t) {
            ...
            var ut = /^(none|table(?!-c[ea]).+)/, lt = {position: "absolute", visibility: "hidden", display: "block"},
            ...
            de.Animation = de.extend(U, {
                ...
                fadeTo: function (e, t, n, r) {
                    ...
                    return "string" != typeof e && (n = t, t = e, e = void 0), t && e !== !1 && this.queue(e || "fx", []), this.each(function () {
                        var t = !0, o = null != e && e + "queueHooks", i = de.timers, a = Fe.get(this);
                    ...
                    return e !== !1 && (e = e || "fx"), this.each(function () {
                        var t, n = Fe.get(this), r = n[e + "queue"], o = n[e + "queueHooks"], i = de.timers,
                            a = r ? r.length : 0;
            ...
            de.fn.extend({
                ...
                addClass: function (e) {
                    ...
                    return "boolean" == typeof t && "string" === n ? t ? this.addClass(e) : this.removeClass(e) : de.isFunction(e) ? this.each(function (n) {
                        ...
                        var t, r, o, i;
                        if ("string" === n) for (r = 0, o = de(this), i = e.match(qe) || []; t = i[r++];) o.hasClass(t) ? o.removeClass(t) : o.addClass(t); else void 0 !== e && "boolean" !== n || (t = X(this), t && Fe.set(this, "__className__", t), this.setAttribute && this.setAttribute("class", t || e === !1 ? "" : Fe.get(this, "__className__") || ""))
                    })
                }, hasClass: function (e) {
                    var t, n, r = 0;
            ...
            de.extend(de.event, {
                trigger: function (t, n, r, o) {
                    var i, a, s, u, l, c, f, p = [r || te], h = le.call(t, "type") ? t.type : t,
                    ...
                    if (a = s = r = r || te, 3 !== r.nodeType && 8 !== r.nodeType && !Ct.test(h + de.event.triggered) && (h.indexOf(".") > -1 && (d = h.split("."), h = d.shift(), d.sort()), l = h.indexOf(":") < 0 && "on" + h, t = t[de.expando] ? t : new de.Event(h, "object" == typeof t && t), t.isTrigger = o ? 2 : 3, t.namespace = d.join("."), t.rnamespace = t.namespace ? new RegExp("(^|\\.)" + d.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, t.result = void 0, t.target || (t.target = r), n = null == n ? [t] : de.makeArray(n, [t]), f = de.event.special[h] || {}, o || !f.trigger || f.trigger.apply(r, n) !== !1)) {
                        ...
                        for (i = 0; (a = p[i++]) && !t.isPropagationStopped();) t.type = i > 1 ? u : f.bindType || h, c = (Fe.get(a, "events") || {})[t.type] && Fe.get(a, "handle"), c && c.apply(a, n), c = l && a[l], c && c.apply && He(a) && (t.result = c.apply(a, n), t.result === !1 && t.preventDefault());
            ...
            var Tt = e.location, kt = de.now(), jt = /\?/;
            ...
            var qt = /%20/g, Dt = /#.*$/, Ot = /([?&])_=[^&]*/, Lt = /^(.*?):[ \t]*([^\r\n]*)$/gm,
                Ht = /^(?:about|app|app-storage|.+-extension|file|res|widget):$/, Ft = /^(?:GET|HEAD)$/, Pt = /^\/\//,
                It = {}, Rt = {}, Mt = "*/".concat("*"), $t = te.createElement("a");
            $t.href = Tt.href, de.extend({
                ...
                ajax: function (t, n) {
                    ...
                    var o, i, a, s, u, l, c, f, p, h, d = de.ajaxSetup({}, n), g = d.context || d,
                        m = d.context && (g.nodeType || g.jquery) ? de(g) : de.event, v = de.Deferred(),
                        y = de.Callbacks("once memory"), b = d.statusCode || {}, x = {}, w = {}, C = "canceled", T = {
            ...
            var _t = {0: 200, 1223: 204}, Wt = de.ajaxSettings.xhr();
            pe.cors = !!Wt && "withCredentials" in Wt, pe.ajax = Wt = !!Wt, de.ajaxTransport(function (t) {
                ...
                if (pe.cors || Wt && !t.crossDomain) return {
                    send: function (o, i) {
                        ...
                        n = function (e) {
                            return function () {
                                n && (n = r = s.onload = s.onerror = s.onabort = s.onreadystatechange = null, "abort" === e ? s.abort() : "error" === e ? "number" != typeof s.status ? i(0, "error") : i(s.status, s.statusText) : i(_t[s.status] || s.status, s.statusText, "text" !== (s.responseType || "text") || "string" != typeof s.responseText ? {binary: s.response} : {text: s.responseText}, s.getAllResponseHeaders()))
                            }
    ...
    3: [function (e, t, n) {
        (function (e) {
            !function (r) {
                ...
                var b, x, w = 2147483647, C = 36, T = 1, k = 26, j = 38, E = 700, N = 72, S = 128, A = "-", q = /^xn--/,
                    D = /[^\x20-\x7E]/, O = /[\x2E\u3002\uFF0E\uFF61]/g, L = {
            ...
            if (!C[h] && (j || h && !T[h])) {
                ...
                if (!D) for (var O = this.hostname.split(/\./), N = 0, L = O.length; N < L; N++) {
                    ...
                    if (H && !H.match(b)) {
                        ...
                        if (!F.match(b)) {
                            var R = O.slice(0, N), M = O.slice(N + 1), $ = H.match(x);
    ...
    13: [function (e, t, n) {
        ...
        function o(e) {
            var t = r(), n = 0;
            i(e) && (e && (n = u(e)), t.unbind("scroll"), t.animate({scrollTop: n}, 800, "swing", function () {
                t.scroll(f)
            }), l(null, e))
        }
        ...
        function u(e) {
            var t = r(), n = t.find(".page-inner"), o = t.find(e), i = o.offsetParent(), u = 0;
        ...
        function f() {
            var e = r(), t = e.scrollTop(), n = e.prop("scrollHeight"), o = e.prop("clientHeight"), i = w.length,
                a = null;
        ...
        function p(e, t) {
            var n = k.parse(A), r = k.resolve(window.location.pathname, e), i = k.parse(r), a = i.hash,
            ...
            var l = T.Deferred(function (e) {
                T.ajax({
                    ...
                    success: function (n, i, s) {
                        ...
                        t && history.pushState({path: u}, null, u), c = T(n), l = c.find("[data-element=head]"), f = c.find(".book"), document.title = l.find("title").text();
                        var h = T("head");
                        h.find("link[rel=prev]").remove(), h.find("link[rel=next]").remove(), h.append(l.find("link[rel=prev]")), h.append(l.find("link[rel=next]"));
                        var g = T(".book").attr("class"), m = T(".book-summary").scrollTop();
        ...
        function d(e) {
            var t = T(".book-body"), n = t.find(".body-inner"), o = n.find(".page-wrapper");
            h(), o.focus();
            var i = r();
            e !== !1 && i.scrollTop(0), w = T(".book-summary .summary .chapter").filter(function () {
                var e = T(this).children("a"), t = null;
        ...
        function x() {
            T.ajaxSetup({cache: !1}), history.replaceState({path: window.location.href}, ""), window.onpopstate = function (e) {
        ...
        var w, C, T = e("jquery"), k = e("url"), j = e("./loading"), E = e("./platform"), N = window.gitbook,
            S = "undefined" != typeof history.pushState, A = location.href;
    ...
    15: [function (e, t, n) {
        ...
        function a(e) {
            ...
            t.find("li").each(function () {
                var t = s(this).data("path"), n = null == e || e.indexOf(t) !== -1;
